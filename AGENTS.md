...
Order By: (user\_api\_key, domain, timestamp) - Optimized for retrieving a specific client's data by time.
...
user\_api\_key (String) - Tenant ID.
...
visitor\_id (String) - Fingerprint.



predicted\_age\_bucket (LowCardinality String) - '18-24', '25-34', etc.



income\_score (UInt8) - 0-100 calculated score.
...
x\_coords Array(UInt16)



y\_coords Array(UInt16)
...
Database tables: snake\_case (Postgres), snake\_case (ClickHouse).
